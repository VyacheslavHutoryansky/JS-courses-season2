...
const { result: [{ accountNumber }] } = data;
const { result: [{ balance: { otb } }] } = data;
const { result: [{ cards: [{ ucid }] }] } = data;
const { result: [{ cards: [{ expireDate }] }] } = data;
const { result: [{ cards: [{ expireDate: { year } }] }] } = data;
const { result: [{ overdraftInfo: { lastCloseDayOverBalance } }] } = data;
const { result: [{ bank: { id } }] } = data;

console.log(" requestId: " + requestId + "\n",
    "result.accountNumber: " + accountNumber + "\n",
    "result.balance.otb: " + otb + "\n",
    "result.cards.ucid: " + ucid + "\n",
    "result.cards.expireDate: " + expireDate + "\n",
